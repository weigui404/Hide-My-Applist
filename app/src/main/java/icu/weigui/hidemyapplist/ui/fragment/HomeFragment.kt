...
import com.weigui.hidemyapplist.BuildConfig
import com.weigui.hidemyapplist.R
import com.weigui.hidemyapplist.databinding.FragmentHomeBinding
import icu.weigui.hidemyapplist.data.fetchLatestUpdate
import icu.weigui.hidemyapplist.hmaApp
import icu.weigui.hidemyapplist.service.ConfigManager
import icu.weigui.hidemyapplist.service.PrefManager
import icu.weigui.hidemyapplist.service.ServiceClient
import icu.weigui.hidemyapplist.ui.activity.AboutActivity
import icu.weigui.hidemyapplist.ui.util.ThemeUtils.getColor
import icu.weigui.hidemyapplist.ui.util.ThemeUtils.themeColor
import icu.weigui.hidemyapplist.ui.util.makeToast
import icu.weigui.hidemyapplist.ui.util.navController
import icu.weigui.hidemyapplist.ui.util.setupToolbar
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.detectionTest.setOnClickListener {
            val intent = hmaApp.packageManager.getLaunchIntentForPackage("icu.weigui.applistdetector")
            if (intent == null) {
                MaterialAlertDialogBuilder(requireContext())
    ...
    override fun onStart() {
        ...
        if (serviceVersion != 0) {
            if (serviceVersion < icu.weigui.hidemyapplist.common.BuildConfig.SERVICE_VERSION) {
